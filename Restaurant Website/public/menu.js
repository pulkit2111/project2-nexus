...
document.querySelectorAll('.adc-button').forEach((button, index) => {
  button.addEventListener('click', () => {
      const itemNames = ['PIZZA', 'PASTA', 'BURGER', 'DOSA', 'PAV BHAJI', 'NOODLES', 'COFFEE', 'MOJITO', 'KITKAT <br> SHAKE', 'BLUEBERRY <br> SMOOTHIE', 'OREO <br> SHAKE', 'TEA', 'PINEAPPLE <br> SUNDAE', 'FUDGE <br> BROWNIE', 'CHEESECAKE', 'CHOCO <br> TRUFFLE', 'CROISSANT', 'CASSATA', 'BLAZING <br> ONION & <br> PEPRIKA', 'FARMHOUSE <br> PIZZA', 'FIERY <br> JALAPINO', 'MEXICAN <br> GREENWAVE', 'PEPPY <br> PANEER', 'VEGGIE <br> PARADISE', 'MOMOS', 'SPRING <br> ROLLS', 'CHILLI <br> POTATO', 'MANCHURIAN', 'PANEER <br> TIKKA', 'SIZZLER' ];
      const itemPrices = [125, 55, 40, 95, 70, 45, 50, 55, 70, 125, 100, 40, 130, 115, 150, 165, 190, 125, 199, 200, 270, 280, 210, 290, 85, 95, 105, 125, 150, 399];
